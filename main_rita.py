...
def get_dataset(args):
    ...
    # Custom EEG channels
    ch_names_custom = [
        'Fp1', 'F3', 'F7', 'FT9', 'FC5', 'FC1', 'C3', 'T7', 'TP9', 'CP5', 'CP1', 'Pz', 'P3', 'P7',
        'O1', 'Oz', 'O2', 'P4', 'P8', 'TP10', 'CP6', 'CP2', 'Cz', 'C4', 'T8', 'FT10', 'FC6', 'FC2', 
        'F4', 'F8', 'Fp2', 'AF7', 'AF3', 'AFz', 'F1', 'F5', 'FT7', 'FC3', 'C1', 'C5', 'TP7', 'CP3', 
        'P1', 'P5', 'PO7', 'PO3', 'POz', 'PO4', 'PO8', 'P6', 'P2', 'CPz', 'CP4', 'TP8', 'C6', 'C2', 
    ...
    if args.train_test_mode == 'intrascan':
        ...
        # Assign custom ch_names directly
        ch_names = ch_names_custom
        ...
        # Here, if you are using the pretrained weights of neurobolt trained on VU dataset, ch_names should be the
        # subset of full_vu channels. Below is an example channel set, you could modify it to adapt your own dataset
        ch_names = ch_names_custom  # Use custom channels for this mode
        spec_chan_ind = [ch_names_custom.index(ch) for ch in ch_names]
