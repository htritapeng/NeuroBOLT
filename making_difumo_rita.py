...
endname = '*.nii.gz'
scanname_length =17 #13  # Number of characters to pick from file name for the scan name
...
#         confounds = motion_confound
    ...
    signals = maps_masker.fit_transform(f, confounds=None)  # it extracts the roi signal first and then remove confounds
    ...
    ts_global_signal_clean = masker_global_signal.fit_transform(f, confounds=None)
